...
<section style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: #0a1a0a;">
    <div style="background: #0f1f0f; border: 1px solid rgba(74,222,128,0.1); border-radius: 16px; padding: 40px; width: 100%; max-width: 420px;">
        ...
        <div style="text-align: center; margin-bottom: 30px;">
            ...
            <p style="color: #86a88a; font-size: 0.95rem;">Entre na sua conta</p>
        </div>
        ...
        <div style="background: rgba(74,222,128,0.1); border: 1px solid #4ade80; color: #4ade80; padding: 12px; border-radius: 8px; margin-bottom: 20px; font-size: 0.9rem;">
            Cadastro realizado! Faça login para continuar.
        </div>
        <?php endif; ?>

        <form method="POST" action="/peres/wazedoagro/public/login">
        ...
        <p style="text-align: center; margin-top: 20px; color: #86a88a; font-size: 0.9rem;">
            Não tem conta?
            <a href="/peres/wazedoagro/public/cadastro" style="color: #4ade80; text-decoration: none; font-weight: 600;">Criar conta</a>
        </p>
